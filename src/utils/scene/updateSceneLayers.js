export const updateSceneLayers = (meshes, pointer, parallaxStrength, applyParallax = true) => {
    for (let i = 0; i < meshes.length; i++) {
        ...
        mesh.position.set(
            origPos.x + transitionOffset.x + px * 0.5,
            origPos.y + transitionOffset.y + py * 0.5,
